  ...
  useEffect(() => {
    const fetchDrivers = async () => {
      try {
        ...
        myHeaders.append(
          'Authorization',
          // 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjE0MjBkNmRlLTFhZGEtNGUwZC04ZWRiLTBlMzMyNjdhOTA2MSIsImZ1bGxuYW1lIjoiTG91YW5nZSIsImlkZW50aWZpZXIiOiJsb3VhbmdlaXl1eWlzZW5nYTIwMDJAZ21haWwuY29tIiwiaWF0IjoxNzA5ODcxNjU4LCJleHAiOjE3MDk5NTgwNTh9.9LD4OmAqqTXE7YWowpN18q0ZFv-gawJicfiDo_c3isU'
        ...
        const response = await fetch('http://127.0.0.1:3000/drivers/', requestOptions);
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {loading ? (
                    ...
                    drivers.map((driver, index) => (
                      <tr className="hover:bg-gray-100" key={driver.id}>
                        <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">
                          #{index + 1}
                        </td>
                        <td className="p-4 whitespace-nowrap text-base font-normal text-gray-500">
