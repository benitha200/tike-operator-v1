...
export default function Trips() {
  ...
  const filteredTrips = trips.filter(trip => {
    const departureLocation = trip.departure_location?.name?.toLowerCase() || '';
    const arrivalLocation = trip.arrival_location?.name?.toLowerCase() || '';
    const driverName = trip.driver?.fullname?.toLowerCase() || '';
    const searchTermLower = searchTerm.toLowerCase();
    
    return departureLocation.includes(searchTermLower) ||
           arrivalLocation.includes(searchTermLower) ||
                  ...
                  {filteredTrips.map((trip, index) => (
                    <tr className="hover:bg-gray-100" key={trip.id}>
                      ...
                      <td className="p-4 whitespace-nowrap text-base font-normal text-gray-500">
                        ...
                        <div className="text-sm font-normal text-gray-500">
                          {trip.formatted_departure_time || trip.departure_time || 'N/A'}
                        </div>
                      </td>
                      <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">
                        <div className="text-base font-semibold text-gray-900">
                        ...
                        <div className="text-sm font-normal text-gray-500">
                          {trip.formatted_arrival_time || trip.arrival_time || 'N/A'}
                        </div>
                      </td>
                      <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">
                        <div className="text-base font-semibold text-gray-900">
